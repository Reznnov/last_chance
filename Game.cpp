...
bool Game::init(const char* title, int width, int height) {
    ...
    player = new Player("\\assets\\ARRRR.png", "\\assets\\p_wa_02_sh4.png", "\\assets\\ARRRR.png", renderer);
    blackHoleAnimation = new BackgroundAnimation("\\assets\\1335091370.png", renderer, 400, 400, 20, -400, -400, 1500, 1500);

    for (int i = 100; i < 1000; i = i + 72) {
        platforms.emplace_back(new Platform("\\assets\\oak_woods_tileset.png", renderer, { 12, 0, 72, 22 }, { i, 500, 72, 22 }));
    }
